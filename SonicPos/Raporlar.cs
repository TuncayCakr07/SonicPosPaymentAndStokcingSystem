  ...
  static class Raporlar
    {
        ...
        public static void RaporSayfasiRaporu(DataGridView dgv)
        {
            ...
            for (int i = 0; i < dgv.Rows.Count; i++)
            {
                list.Add(new IslemOzet
                {
                    ...
                    KrediKartı = Islemler.DoubleYap(dgv.Rows[i].Cells["KrediKartı"].Value.ToString()),
        ...
        public static void MusteriRaporu(DataGridView dgv)
        {
            Cursor.Current = Cursors.WaitCursor;
            ...
            f.reportViewer1.LocalReport.DataSources.Clear();
            f.reportViewer1.LocalReport.DataSources.Add(rs);
            f.reportViewer1.LocalReport.ReportPath = Application.StartupPath + @"\rpMusteri.rdlc";
